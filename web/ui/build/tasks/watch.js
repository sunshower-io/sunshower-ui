var gulp = require('gulp'),
    ...
    tsPaths = [].concat(paths.source).concat(paths.dtsSrc);
...
gulp.task('watch', ['serve'], function () {
    gulp.watch(tsPaths, ['build-system', browserSync.reload]).on('change', reportChange);
    ...
    gulp.watch(paths.scss, ['sass', browserSync.reload]).on('change', reportChange);
