import {IllegalStateException} from "../../core/exceptions/type-errors";
...
export class LocalStorage implements Map<string, string> {
    ...
    constructor() {
        ...
        if(typeof(Storage) == undefined) {
            throw new IllegalStateException("This browser " +
...
export class CookieStorage implements Map<string, string> {
    ...
    private parse(values: {[index: string]: string}, value: string): {[index:string]:string}{
        if (value) {
